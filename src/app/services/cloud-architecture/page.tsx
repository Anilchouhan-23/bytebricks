...
export const metadata = buildMetadata({
  ...
  description:
    "Plan, migrate, and optimize cloud infrastructure with ByteBricks cloud architecture and DevOps services.",
  path: "/services/cloud-architecture",
  keywords: ["Cloud Architecture", "Cloud Migration", "AWS", "Azure", "DevOps"],
});
